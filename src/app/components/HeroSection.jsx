            ...
            <br></br>
                    <TypeAnimation
                        sequence={[
                            ...
                            1000,
                            'Final-Year CS Student @ VIT',
                            1000,
                            'Backend & Full-Stack Developer',
                            1000,
                            'Spring Boot • Django • Golang Experienced',
                            1000,
                            'Can we connect?',
                            1000
                        ]}
                ...
                <Link href="https://drive.google.com/file/d/1WfxqdaP1mqndCExf2EChvvTtBv1vkg_Y/view?usp=sharing"><button className='px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br to-blue-500 via-purple-500 from-pink-500 hover:bg-slate-800 text-white mt-4'>
